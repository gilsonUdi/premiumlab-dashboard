...
function normalizeCompanyCodeFilter(company = {}) {
  ...
  return {
    ...
    code,
    powerBiTable: String(company.companyCodePowerBiTable || 'Vendas').trim() || 'Vendas',
    powerBiColumn: String(company.companyCodePowerBiColumn || 'COD_EMPRESA').trim() || 'COD_EMPRESA',
  }
}
...
export function normalizeCompanyPortalSettings(company = {}) {
  ...
  return {
    ...
    companyCodePowerBiTable: companyCodeFilter.powerBiTable,
    companyCodePowerBiColumn: companyCodeFilter.powerBiColumn,
  }
}
...
export function getCompanyCodeFilter(company) {
  ...
  return {
    ...
    powerBiTable: settings.companyCodePowerBiTable,
    powerBiColumn: settings.companyCodePowerBiColumn,
  }
}
