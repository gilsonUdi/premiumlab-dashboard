...
export async function ensurePremiumLabTenant() {
  ...
  await authorizedAdminRequest('/api/admin/companies', {
    ...
    body: JSON.stringify({
      ...
      companyCodePowerBiTable: existingCompany?.companyCodePowerBiTable || PREMIUM_COMPANY.companyCodePowerBiTable,
      companyCodePowerBiColumn: existingCompany?.companyCodePowerBiColumn || PREMIUM_COMPANY.companyCodePowerBiColumn,
